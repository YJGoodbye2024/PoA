...
# """使用的是官方的Google search API""

# DEFAULT_PROXY = "http://127.0.0.1:10804"
# for proxy_key in ("http_proxy", "https_proxy", "HTTP_PROXY", "HTTPS_PROXY"):
#     os.environ.setdefault(proxy_key, DEFAULT_PROXY)
...
# _DEFAULT_API_ENV = "GEMINI_API_KEY"
# _API_KEY_ENV_NAME = _DEFAULT_API_ENV
...
#     """
#     获取当前选择的 Gemini API Key。
#     """
#     value = os.getenv(_API_KEY_ENV_NAME)
#     if value:
#         return value
#     raise RuntimeError(f"{_API_KEY_ENV_NAME} environment variable is not set.")


# def configure_api_slot(slot: Optional[int]) -> None:
#     """
#     根据命令行参数选择要使用的 API Key 环境变量。
#     """
#     global _API_KEY_ENV_NAME, _GENAI_CLIENT
#     if slot is None or slot == 0:
#         _API_KEY_ENV_NAME = _DEFAULT_API_ENV
#     else:
#         _API_KEY_ENV_NAME = f"{_DEFAULT_API_ENV}{slot}"
#     _GENAI_CLIENT = None  # 下次使用客户端时重新初始化


# def _get_genai_client() -> genai.Client:
#     """
#     懒加载并缓存 Google GenAI 客户端实例。
#     """
...
#     """
#     print(f"[info] ({index}/{total}) Requesting {principle_name}...")
#     try:
#         content: str = await asyncio.wait_for(
#             asyncio.to_thread(fetch_references, principle_name),
...
#     tasks = [
#         asyncio.create_task(
#             _worker(principle, idx, total, output_dir))
...
#         description=(
#             "Query the Gemini models API for every psychological principle "
#             "listed in sd_pri_list and td_pri_list_100."
#         )
#     )
#     parser.add_argument(
#         "--principles",
...
#         type=int,
#         choices=range(0, 10),
#         help="Select which GEMINI_API_KEY slot to use (0 uses GEMINI_API_KEY, n>0 uses GEMINI_API_KEYn).",
#     )
...
#     """
#     args = parse_args()
#     configure_api_slot(getattr(args, "api_slot", None))
